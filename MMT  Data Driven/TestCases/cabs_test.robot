...
Library             DataDriver    file=${DEV_TD}${/}cabs_test_data.xlsx    sheet_name=${SHEET_NAME}

Test Template     Outstation One Way Cab Booking Flow Template
Test Setup        Open MakeMyTrip On Chrome
Test Teardown     Close The Browser


*** Variables ***

${DEV_TD}    ${CURDIR}${/}..${/}TestData
${SHEET_NAME}    Sheet1
...
*** Test Cases ***
Outstation One Way Cab Booking Flow With Data    ${TC_ID}

*** Keywords ***
Outstation One Way Cab Booking Flow Template
    [Arguments]    ${TC_ID}
    # Setup
    ...
    # Load Test Data
    &{test_data}=    Fetch Testdata By Id    ${DEV_TD}${/}cabs_test_data.xlsx    ${SHEET_NAME}    ${TC_ID}
